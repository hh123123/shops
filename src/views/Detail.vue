    ...
    <div class="am-container header">
      ...
      <ul class="message-r">
        <div class="topMessage home">
          <div class="menu-hd">
            <a href="#" target="_top" class="h" @click="Home">商城首页</a>
          </div>
        </div>
        ...
        <div class="topMessage mini-cart">
          <div class="menu-hd">
            <a id="mc-menu-hd" href="#" target="_top" @click="Cart">
    ...
    <div class="listMain">
      ...
      <div class="item-inform" v-for="item in products" :key="item._id">
        <div class="clearfixLeft" id="clearcontent">
          <div class="box">
            <img-zoom
              :src="'https://api.cat-shop.penkuoer.com'+item.coverImg"
              width="400"
              height="450"
              :bigsrc="'https://api.cat-shop.penkuoer.com'+item.coverImg"
              :configs="configs"
            ></img-zoom>
          </div>
          <div class="clear"></div>
                        ...
                        <div class="theme-options">
                          ...
                          <dd>
                            <input
                              ...
                              @click="reduce"
                            >
                            <!-- <input id="text_box" name="" type="text" value="11" style="width:30px;" />-->
          ...
          <div class="mc">
            <ul>
              ...
              <li class="first">
                <div class="p-img">
                  <a href="#">
                    <img class src="../images/browse1.jpg">
                  </a>
                </div>
                <div class="p-name">
                    ...
                    <div class="am-comment-main">
                      ...
                      <div class="am-comment-bd">
                        <div class="tb-rev-item" data-id="255776406962">
                          <div
                            class="J_TbcRate_ReviewContent tb-tbcr-content"
                          >摸起来丝滑柔软，不厚，没色差，颜色好看！买这个衣服还接到诈骗电话，我很好奇他们是怎么知道我买了这件衣服，并且还知道我的电话的！</div>
